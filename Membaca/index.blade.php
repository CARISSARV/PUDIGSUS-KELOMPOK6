        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <a href="{{ route('membaca.create') }}" class="btn btn-md btn-success mb-3">TAMBAH DATA</a>
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @forelse ($data as $Membaca)
                                <tr>

                                    </td>
                                    <td>{{ $Membaca->Tanggal_baca
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('membaca.destroy', $Membaca->id_Baca) }}" method="post">
                                            <a href="{{ route('membaca.edit', $Membaca->id_Baca) }}" class="btn btn-sm btn-primary">EDIT</a>
